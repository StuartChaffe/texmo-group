...
<div class="bkg--white career-details--additional">
	...
	<section class="career-details--list">
		<ul class="accordion-list">
			...
			<?php if ( $data['location']['name'] == 'Sheffield' || $data['location']['name'] == 'Indiana' || $data['location']['name'] == 'Coimbatore' )  { ?>
			<li>
				<button class="accordion--title" aria-expanded="false"><svg class="icon icon--open"><use xlink:href="#accordion-arrow"></use></svg>About the Hiring Team</button>
				<div class="accordion--content">
